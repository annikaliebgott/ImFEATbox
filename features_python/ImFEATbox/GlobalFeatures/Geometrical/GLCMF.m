function [Out] = GLCMF(I, InputParameters, typeflag)
% Input:     - I: A 2D image
...
if ~exist('InputParameters','var') || ~isfield(InputParameters,'GrayLimits')
    InputParameters.GrayLimits = [min(I(:)) max(I(:))];
end
...
GLCM_Matrices = graycomatrix(I, 'offset', InputParameters.DisplacementVector,...
